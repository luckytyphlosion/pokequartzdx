static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 25, 15},
    ...
    {MAP_GROUP(LILYCOVE_CITY), MAP_NUM(LILYCOVE_CITY), 11, 24},
    {MAP_GROUP(MOSSDEEP_CITY), MAP_NUM(MOSSDEEP_CITY), 28, 17},
    {MAP_GROUP(SOOTOPOLIS_CITY), MAP_NUM(SOOTOPOLIS_CITY), 43, 32},
    {MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY), 22, 49},
